...
class $UsersTable extends Users with TableInfo<$UsersTable, User> {
  ...
  late final GeneratedColumnWithTypeConverter<Map<String, dynamic>?, String>
      businessInfo = GeneratedColumn<String>('business_info', aliasedName, true,
              type: DriftSqlType.string, requiredDuringInsert: false)
          .withConverter<Map<String, dynamic>?>(
              $UsersTable.$converterbusinessInfon);
  ...
  User map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return User(
      ...
      businessInfo: $UsersTable.$converterbusinessInfon.fromSql(attachedDatabase
          .typeMapping
...
class User extends DataClass implements Insertable<User> {
  ...
  factory User.fromJson(Map<String, dynamic> json,
    ...
    return User(
      ...
      businessInfo:
          serializer.fromJson<Map<String, dynamic>?>(json['businessInfo']),
  ...
  @override
  int get hashCode => Object.hash(id, email, fullName, businessName, province,
      businessInfo, createdAt, updatedAt);
  @override
...
class $ClientsTable extends Clients with TableInfo<$ClientsTable, Client> {
  ...
  Client map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Client(
      ...
      address: $ClientsTable.$converteraddress.fromSql(attachedDatabase
          .typeMapping
      ...
      rateHistory: $ClientsTable.$converterrateHistory.fromSql(attachedDatabase
          .typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}rate_history'])!),
      createdAt: attachedDatabase.typeMapping
          .read(DriftSqlType.dateTime, data['${effectivePrefix}created_at'])!,
      updatedAt: attachedDatabase.typeMapping
          .read(DriftSqlType.dateTime, data['${effectivePrefix}updated_at'])!,
...
class Client extends DataClass implements Insertable<Client> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['address'] =
          Variable<String>($ClientsTable.$converteraddress.toSql(address));
    }
    {
  ...
  factory Client.fromJson(Map<String, dynamic> json,
    ...
    return Client(
      ...
      billingPreferences:
          serializer.fromJson<Map<String, dynamic>>(json['billingPreferences']),
      rateHistory:
          serializer.fromJson<Map<String, double>>(json['rateHistory']),
      createdAt: serializer.fromJson<DateTime>(json['createdAt']),
      updatedAt: serializer.fromJson<DateTime>(json['updatedAt']),
    );
  }
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'billingPreferences':
          serializer.toJson<Map<String, dynamic>>(billingPreferences),
  ...
  Client copyWithCompanion(ClientsCompanion data) {
    return Client(
      ...
      billingPreferences: data.billingPreferences.present
  ...
  @override
  int get hashCode => Object.hash(id, name, company, email, phone, address,
      billingPreferences, rateHistory, createdAt, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Client &&
...
class ClientsCompanion extends UpdateCompanion<Client> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (billingPreferences.present) {
      map['billing_preferences'] = Variable<String>($ClientsTable
          .$converterbillingPreferences
          .toSql(billingPreferences.value));
    }
...
class $DailyLogsTable extends DailyLogs
  ...
  late final GeneratedColumnWithTypeConverter<BillingMethod, String>
      billingMethod = GeneratedColumn<String>(
              'billing_method', aliasedName, false,
              type: DriftSqlType.string, requiredDuringInsert: true)
          .withConverter<BillingMethod>(
              $DailyLogsTable.$converterbillingMethod);
  ...
  late final GeneratedColumn<double> regularHours = GeneratedColumn<double>(
      'regular_hours', aliasedName, true,
  ...
  late final GeneratedColumn<double> hourlyRate = GeneratedColumn<double>(
      ...
      type: DriftSqlType.double, requiredDuringInsert: false);
  static const VerificationMeta _overtimeRateMeta =
      const VerificationMeta('overtimeRate');
  @override
  late final GeneratedColumn<double> overtimeRate = GeneratedColumn<double>(
      'overtime_rate', aliasedName, true,
      type: DriftSqlType.double, requiredDuringInsert: false);
  static const VerificationMeta _dayRateMeta =
      const VerificationMeta('dayRate');
  @override
  late final GeneratedColumn<double> dayRate = GeneratedColumn<double>(
      'day_rate', aliasedName, true,
      type: DriftSqlType.double, requiredDuringInsert: false);
  static const VerificationMeta _isFullDayMeta =
      const VerificationMeta('isFullDay');
  @override
  late final GeneratedColumn<bool> isFullDay = GeneratedColumn<bool>(
      'is_full_day', aliasedName, false,
      type: DriftSqlType.bool,
      requiredDuringInsert: false,
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('CHECK ("is_full_day" IN (0, 1))'),
      defaultValue: const Constant(false));
  @override
  late final GeneratedColumnWithTypeConverter<Map<String, double>, String>
      expenses = GeneratedColumn<String>('expenses', aliasedName, false,
              type: DriftSqlType.string, requiredDuringInsert: true)
          .withConverter<Map<String, double>>(
              $DailyLogsTable.$converterexpenses);
    ...
    if (data.containsKey('overtime_rate')) {
      context.handle(
          ...
          overtimeRate.isAcceptableOrUnknown(
              data['overtime_rate']!, _overtimeRateMeta));
    }
    if (data.containsKey('day_rate')) {
      context.handle(_dayRateMeta,
    ...
    return DailyLog(
      ...
      billingMethod: $DailyLogsTable.$converterbillingMethod.fromSql(
          attachedDatabase.typeMapping.read(
              DriftSqlType.string, data['${effectivePrefix}billing_method'])!),
      ...
      overtimeRate: attachedDatabase.typeMapping
          .read(DriftSqlType.double, data['${effectivePrefix}overtime_rate']),
      dayRate: attachedDatabase.typeMapping
          .read(DriftSqlType.double, data['${effectivePrefix}day_rate']),
      isFullDay: attachedDatabase.typeMapping
          .read(DriftSqlType.bool, data['${effectivePrefix}is_full_day'])!,
      expenses: $DailyLogsTable.$converterexpenses.fromSql(attachedDatabase
          .typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}expenses'])!),
      description: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}description']),
      status: $DailyLogsTable.$converterstatus.fromSql(attachedDatabase
          .typeMapping
...
class DailyLog extends DataClass implements Insertable<DailyLog> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['expenses'] =
          Variable<String>($DailyLogsTable.$converterexpenses.toSql(expenses));
    }
    ...
    {
      map['status'] =
          Variable<String>($DailyLogsTable.$converterstatus.toSql(status));
    }
    map['created_at'] = Variable<DateTime>(createdAt);
    map['updated_at'] = Variable<DateTime>(updatedAt);
    return map;
  ...
  DailyLogsCompanion toCompanion(bool nullToAbsent) {
    return DailyLogsCompanion(
      ...
      regularHours: regularHours == null && nullToAbsent
          ? const Value.absent()
          : Value(regularHours),
      ...
      hourlyRate: hourlyRate == null && nullToAbsent
          ? const Value.absent()
          : Value(hourlyRate),
      overtimeRate: overtimeRate == null && nullToAbsent
          ? const Value.absent()
          : Value(overtimeRate),
      dayRate: dayRate == null && nullToAbsent
          ? const Value.absent()
          : Value(dayRate),
  ...
  DailyLog copyWith(
      ...
      DailyLog(
        ...
        regularHours:
            regularHours.present ? regularHours.value : this.regularHours,
        overtimeHours:
        ...
        overtimeRate:
            overtimeRate.present ? overtimeRate.value : this.overtimeRate,
  ...
  DailyLog copyWithCompanion(DailyLogsCompanion data) {
    return DailyLog(
      ...
      billingMethod: data.billingMethod.present
      ...
      overtimeRate: data.overtimeRate.present
...
class $InvoicesTable extends Invoices with TableInfo<$InvoicesTable, Invoice> {
  ...
  late final GeneratedColumnWithTypeConverter<Map<String, double>, String>
      expenses = GeneratedColumn<String>('expenses', aliasedName, false,
              type: DriftSqlType.string, requiredDuringInsert: true)
          .withConverter<Map<String, double>>(
              $InvoicesTable.$converterexpenses);
  ...
  Invoice map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Invoice(
      ...
      expenses: $InvoicesTable.$converterexpenses.fromSql(attachedDatabase
          .typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}expenses'])!),
...
class Invoice extends DataClass implements Insertable<Invoice> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['expenses'] =
          Variable<String>($InvoicesTable.$converterexpenses.toSql(expenses));
    }
...
class InvoiceLineItem extends DataClass implements Insertable<InvoiceLineItem> {
  ...
  @override
  int get hashCode => Object.hash(
      id, invoiceId, description, quantity, rate, amount, sortOrder, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $RateTemplatesTable extends RateTemplates
  ...
  late final GeneratedColumnWithTypeConverter<BillingMethod, String>
      billingMethod = GeneratedColumn<String>(
              ...
              type: DriftSqlType.string, requiredDuringInsert: true)
          .withConverter<BillingMethod>(
              $RateTemplatesTable.$converterbillingMethod);
  static const VerificationMeta _hourlyRateMeta =
      const VerificationMeta('hourlyRate');
  @override
  late final GeneratedColumn<double> hourlyRate = GeneratedColumn<double>(
  ...
  @override
  VerificationContext validateIntegrity(Insertable<RateTemplate> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
...
class RateTemplatesCompanion extends UpdateCompanion<RateTemplate> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (billingMethod.present) {
      map['billing_method'] = Variable<String>($RateTemplatesTable
          .$converterbillingMethod
          .toSql(billingMethod.value));
    }
    if (hourlyRate.present) {
      map['hourly_rate'] = Variable<double>(hourlyRate.value);
    }
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final RateTemplateDao rateTemplateDao =
      RateTemplateDao(this as AppDatabase);
  @override
  Iterable<TableInfo<Table, Object?>> get allTables =>
      allSchemaEntities.whereType<TableInfo<Table, Object?>>();
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities =>
      [users, clients, dailyLogs, invoices, invoiceLineItems, rateTemplates];
}
...
class $$ClientsTableOrderingComposer
  ...
  ColumnOrderings<String> get rateHistory => $composableBuilder(
      column: $table.rateHistory, builder: (column) => ColumnOrderings(column));
...
class $$ClientsTableAnnotationComposer
  ...
  GeneratedColumnWithTypeConverter<Map<String, dynamic>, String>
      get billingPreferences => $composableBuilder(
          column: $table.billingPreferences, builder: (column) => column);

  GeneratedColumnWithTypeConverter<Map<String, double>, String>
      get rateHistory => $composableBuilder(
          column: $table.rateHistory, builder: (column) => column);
...
class $$DailyLogsTableFilterComposer
  ...
  ColumnFilters<double> get overtimeRate => $composableBuilder(
      column: $table.overtimeRate, builder: (column) => ColumnFilters(column));

  ColumnFilters<double> get dayRate => $composableBuilder(
      column: $table.dayRate, builder: (column) => ColumnFilters(column));

  ColumnFilters<bool> get isFullDay => $composableBuilder(
      column: $table.isFullDay, builder: (column) => ColumnFilters(column));
...
class $$DailyLogsTableOrderingComposer
  ...
  ColumnOrderings<double> get dayRate => $composableBuilder(
      column: $table.dayRate, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<bool> get isFullDay => $composableBuilder(
      column: $table.isFullDay, builder: (column) => ColumnOrderings(column));
...
class $$DailyLogsTableAnnotationComposer
  ...
  GeneratedColumnWithTypeConverter<BillingMethod, String> get billingMethod =>
      $composableBuilder(
          column: $table.billingMethod, builder: (column) => column);
  ...
  GeneratedColumn<double> get overtimeRate => $composableBuilder(
      column: $table.overtimeRate, builder: (column) => column);
...
class $$InvoiceLineItemsTableTableManager extends RootTableManager<
  ...
  $$InvoiceLineItemsTableTableManager(
      _$AppDatabase db, $InvoiceLineItemsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
...
typedef $$InvoiceLineItemsTableProcessedTableManager = ProcessedTableManager<
    ...
    InvoiceLineItem,
    PrefetchHooks Function()>;
typedef $$RateTemplatesTableCreateCompanionBuilder = RateTemplatesCompanion
    Function({
  required String id,
  required String name,
  Value<String?> description,
...
typedef $$RateTemplatesTableUpdateCompanionBuilder = RateTemplatesCompanion
    Function({
  Value<String> id,
  Value<String> name,
  Value<String?> description,
...
class $$RateTemplatesTableTableManager extends RootTableManager<
    _$AppDatabase,
    $RateTemplatesTable,
    RateTemplate,
    $$RateTemplatesTableFilterComposer,
  ...
  $$RateTemplatesTableTableManager(_$AppDatabase db, $RateTemplatesTable table)
      : super(TableManagerState(
          ...
          createComputedFieldComposer: () =>
              $$RateTemplatesTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback: ({
            Value<String> id = const Value.absent(),
            Value<String> name = const Value.absent(),
            Value<String?> description = const Value.absent(),
...
typedef $$RateTemplatesTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $RateTemplatesTable,
    RateTemplate,
    $$RateTemplatesTableFilterComposer,
